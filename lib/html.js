...
<div class="chapter-list">
  ...
  <ul>
    ${chapterListItems}
    <li><a href="#kg-wrap" class="ch-list-link"><span class="ch-list-num">—</span><span class="ch-list-body"><span class="ch-list-title">Knowledge Graph</span><span class="ch-list-sub">Interactive concept map linking key ideas across all chapters</span></span></a></li>
  </ul>
</div>
