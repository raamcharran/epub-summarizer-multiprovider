...
.ch-list-link{display:flex;align-items:flex-start;gap:16px;padding:12px 0;border-bottom:1px solid #1e2e2e;color:#aaa;text-decoration:none;transition:color .15s}
.ch-list-link:hover{color:#ff6b4a;text-decoration:none}
.ch-list-link:hover .ch-list-sub{color:#ff8c75}
.ch-list-num{flex-shrink:0;font-size:.65rem;font-weight:700;color:#ff6b4a;letter-spacing:.12em;min-width:22px;padding-top:3px}
.ch-list-body{display:flex;flex-direction:column;gap:3px}
.ch-list-title{font-size:.9rem;font-weight:600;color:#ddd;line-height:1.3}
.ch-list-link:hover .ch-list-title{color:#ff6b4a}
.ch-list-sub{font-size:.78rem;font-weight:400;color:#666;line-height:1.45}
.kg-list-link{display:flex;align-items:flex-start;gap:16px;padding:12px 0;margin-top:8px;border-top:1px solid #ff6b4a;color:#aaa;text-decoration:none;transition:color .15s}
.kg-list-link:hover{color:#ff6b4a;text-decoration:none}
.kg-list-link:hover .ch-list-sub{color:#ff8c75}
.kg-list-link .ch-list-title{color:#ff6b4a}
.kg-list-link .ch-list-num{color:#ff6b4a}
...
.scroll-progress{position:fixed;top:0;left:0;height:3px;background:linear-gradient(90deg,#ff6b4a,#ff8c75);z-index:200;width:0;pointer-events:none;transition:none;will-change:width}
.top-nav{top:3px}
...
.top-nav .nav-links a.active{color:#ff6b4a;box-shadow:inset 0 -2px 0 #ff6b4a}
